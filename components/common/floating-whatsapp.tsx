...
export function FloatingWhatsApp({ message }: FloatingWhatsAppProps) {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex animate-scale-in items-center gap-2 rounded-full bg-whatsapp px-4 py-3.5 shadow-lg shadow-black/50 transition-transform duration-200 ease-sport hover:scale-105 active:scale-95"
    >
