...
export default function NotFound() {
  return (
    <>
      <Header />
      <main className="mx-auto flex min-h-[60vh] max-w-6xl flex-col items-center justify-center gap-6 px-4 py-20 text-center">
        ...
        <p className="max-w-md font-sans text-fg-muted">
          Halaman yang Anda cari mungkin telah dipindahkan atau tidak tersedia. Kembali ke jalur
          utama.
        </p>
